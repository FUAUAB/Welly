...
------------- | ------------- | -------------
[**getAllDocumentTypes**](DocumentTypeApi.md#getAllDocumentTypes) | **GET** /api/DocumentType | Get a list of all document types.
[**getDocumentById**](DocumentTypeApi.md#getDocumentById) | **GET** /api/DocumentType/{Id} | Get documenttype by id.
...
var api_instance = new DocumentTypeApi();

try { 
    var result = api_instance.getAllDocumentTypes();
    print(result);
} catch (e) {
    print("Exception when calling DocumentTypeApi->getAllDocumentTypes: $e\n");
}
```
...
# **getDocumentById**
> DocumentType getDocumentById(id)
...
try { 
    var result = api_instance.getDocumentById(id);
    print(result);
} catch (e) {
    print("Exception when calling DocumentTypeApi->getDocumentById: $e\n");
}
```
