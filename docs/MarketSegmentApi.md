...
var api_instance = new MarketSegmentApi();

try { 
    var result = api_instance.getMarketSegments();
    print(result);
} catch (e) {
...
[**List<MarketSegment>**](MarketSegment.md)
...
# **segmentation**
> List<SegmentCustomer> segmentation()
...
try { 
    var result = api_instance.segmentation();
    print(result);
} catch (e) {
...
[**List<SegmentCustomer>**](SegmentCustomer.md)
