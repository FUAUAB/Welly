...
class CompanyApi {
  ...
  ///
  ///
  Future<List<CompanyInformation>> getAllCompanies() async {
    Object postBody = null;

    // verify required params are set

    // create path and map variables
    String path = "/api/Company".replaceAll("{format}", "json");
    ...
    if (response.statusCode >= 400) {
      ...
      return (apiClient.deserialize(response.body, 'List<CompanyInformation>')
              as List)
          .map((item) => item as CompanyInformation)
          .toList();
    } else {
      return null;
    }
  ...
  Future<CompanyDetails> getCompanyDetails(int companyId) async {
    ...
    // create path and map variables
    String path = "/api/Company/{companyId}"
    ...
    if (response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'CompanyDetails')
          as CompanyDetails;
    } else {
      return null;
    }
