...
class StockApi {
  ...
  ///
  ///
  Future<List<StockChangeType>> stockChangeTypes({int companyId}) async {
    Object postBody = null;

    // verify required params are set

    // create path and map variables
    String path = "/api/Stock/StockChangeTypes".replaceAll("{format}", "json");
    ...
    if (response.statusCode >= 400) {
      ...
      return (apiClient.deserialize(response.body, 'List<StockChangeType>')
              as List)
          .map((item) => item as StockChangeType)
          .toList();
    } else {
      return null;
    }
  ...
  ///
  Future stockChanges(
      {int companyId, int branchId, List<StockChange> stockChanges}) async {
    Object postBody = stockChanges;

    // verify required params are set

    // create path and map variables
    String path = "/api/Stock/StockChanges".replaceAll("{format}", "json");
